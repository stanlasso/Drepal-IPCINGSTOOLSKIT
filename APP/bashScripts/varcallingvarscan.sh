...
rm -rf APP/data/variants.varscan/*_all_variants.vcf && rm -rf APP/data/variants.varscan/*_file.mpileup
...
do
    ...
    varscan pileup2cns APP/data/variants.varscan/"$id"_file.mpileup --min-coverage $Dp --min-avg-qual $Qual > APP/data/variants.varscan/"$id"_all_variants.vcf
